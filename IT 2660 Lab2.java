...
public class Main {
    public static void main(String[] args) {
        // Instantiate the Lab2 class to run the methods
        Lab2 lab = new Lab2();
        
        System.out.println("********** LINKED LIST RESULTS **********");
        lab.linkedList();
...
class Lab2 {
    ...
    public void queue() {
        ...
        String removedElement = q.poll(); // poll() is safer than remove() as it returns null if empty
